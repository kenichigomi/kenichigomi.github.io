+++
date = '2026-07-28T17:03:57-04:00'
draft = true
title = 'Resume'
+++
...
<div style="display: flex; justify-content: space-between;">
  <strong>ノースイースターン大学</strong>
  <span>2022年9月 ~ 2026年4月</span>
</div>
...
# 技術
**プログラミング言語:** *Python, SQL, R, HTML, CSS, JavaScript, Markdown* \
**開発者ツール:** *VSCode, RStudio, AWS, ArcGIS, Microsoft Office, DBT, GitHub, Tableau, Anaconda, Atlassian*
...
<!-- Experience Begin -->
<div style="display: flex; justify-content: space-between;">
  <strong>TA for Information Visualization</strong>
...
<!-- Experience Begin -->
<div style="display: flex; justify-content: space-between;">
  <strong>Data Research Co-op</strong>
  <span>July 2024 ~ December 2024</span>
</div>
<div style="display: flex; justify-content: space-between;">
  <i>Montai Therapeutics</i>
  <i>Cambridge, MA</i>
</div>
<div>
  <ul style="margin-top: 0;">
...
<!-- Experience Begin -->
<div style="display: flex; justify-content: space-between;">
  <strong>TA for Intermediate Programming with Data</strong>
...
<div style="display: flex; justify-content: space-between;">
  ...
  <span>November 2023 ~ July 2024</span>
</div>
<div style="display: flex; justify-content: space-between;">
  <i>Japonaise Bakery and Cafe</i>
  <i>Brookline, MA</i>
</div>
<div>
  <ul style="margin-top: 0;">
...
# その他
**言語:** 英語 (母国語), 日本語 (母国語), スペイン語 (基礎)\
**Hobbies:** ランニング, サイクリング, キャンピング, 写真撮影, Baba Is You(あんまり上手ではない)
